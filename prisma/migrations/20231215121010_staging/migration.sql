/*
  ...
  - You are about to drop the column `flashcard_url` on the `Flashcards` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `Flashcards` DROP COLUMN `flashcard_url`,
    DROP COLUMN `status`,
    DROP COLUMN `title`;
